...
var server = http.createServer(function (req, res) {
  ...
  if ((req.url == '/')) { //check the URL of the current request
    ...
    res.write('<html><body><h1>Welcome to my Node.js Application</h1><p>Welcome John Smith. This activity is about basics of Node.js</p> </body></html>');
    res.end();
  } 
  
  else if ((req.url == '/about')) {
    res.writeHead(200, { 'Content-Type': 'text/html' });
    res.write('<html><body><h>This is the About Page</h1><p>Hello John Smith. This activity will teach you on how to deal with a simple server and local modules in Node.js</p></body></html>');
    res.end();
  } 
